...
> **"Existing NDAA components either fast follow or lack right sized SWaP/features or upport. Non-NDAA options add untenable risk. Substep's NDAA high performance components are the ones we wish we had from prototype to production."** - Substep team after designing and shipping systems in all domains. 
